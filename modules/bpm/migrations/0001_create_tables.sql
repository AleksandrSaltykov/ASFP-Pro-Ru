...
-- +goose Down
DROP TABLE IF EXISTS bpm.escalation;
DROP TABLE IF EXISTS bpm.assignment_rule;
DROP TABLE IF EXISTS bpm.task;
DROP TABLE IF EXISTS bpm.form;
DROP TABLE IF EXISTS bpm.process_definition;
