...
-- +goose Down
DROP TABLE IF EXISTS docs.document_signer;
DROP TABLE IF EXISTS docs.document;
DROP TABLE IF EXISTS docs.signer;
DROP TABLE IF EXISTS docs.number_sequence;
DROP TABLE IF EXISTS docs.template;
