...
const directoriesNav: NavItem[] = [
  { to: '/directories?view=catalogs', label: 'Каталоги', icon: 'document' },
  { to: '/directories?view=items', label: 'Номенклатура', icon: 'barcode' }
];

export const LegacyMainLayout = () => {
  ...
  return (
    <div style={wrapperStyle}>
      ...
      <aside style={sidebarStyle}>
        ...
        <nav aria-label="Справочники" style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <span style={sectionLabelStyle}>Справочники</span>
